...
public class mun4Activity extends Activity{
    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mun4_layout);
        botonregresar();
        botoninicio();
        botonavanzar();
    }
    ...
    private void botonregresar(){
        ...
        accionregresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(mun4Activity.this, mun3Activity.class));}});
    }
    ...
    private void botoninicio(){
        ...
        accioninicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(mun4Activity.this, MainActivity.class));}});
    }
    ...
    private void botonavanzar(){
        ...
        accionavanza.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(mun4Activity.this, mun5Activity.class));}});
    }
